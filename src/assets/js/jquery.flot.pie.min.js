...
(function (e) {
    function r(r) {
        ...
        function v(r, s) {
            ...
            function b() {
                var e = i.series.pie.shadow.left, t = i.series.pie.shadow.top, n = 10, r = i.series.pie.shadow.alpha,
            ...
            function w() {
                ...
                function d() {
                    function l(t, n, s) {
                        ...
                        var d = (n + t.angle + n) / 2, v = a + Math.round(Math.cos(d) * r),
            ...
            if (!o) return;
            var h = r.getPlaceholder().width(), p = r.getPlaceholder().height(),
        ...
        function y(e, t) {
            var n = r.getData(), i = r.getOptions(),
                s = i.series.pie.radius > 1 ? i.series.pie.radius : u * i.series.pie.radius, o, l;
            for (var h = 0; h < n.length; ++h) {
                ...
                if (p.pie.show) {
                    ...
                    if (c.isPointInPath) {
                        ...
                        var d = s * Math.cos(p.startAngle), v = s * Math.sin(p.startAngle),
                            m = s * Math.cos(p.startAngle + p.angle / 4), y = s * Math.sin(p.startAngle + p.angle / 4),
                            b = s * Math.cos(p.startAngle + p.angle / 2), w = s * Math.sin(p.startAngle + p.angle / 2),
                            E = s * Math.cos(p.startAngle + p.angle / 1.5),
                            S = s * Math.sin(p.startAngle + p.angle / 1.5), x = s * Math.cos(p.startAngle + p.angle),
                            T = s * Math.sin(p.startAngle + p.angle),
                            N = [[0, 0], [d, v], [m, y], [b, w], [E, S], [x, T]], C = [o, l];
