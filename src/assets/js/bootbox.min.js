...
window.bootbox = window.bootbox || function a(b, c) {
    ...
    }, p = b("body"), q = {locale: "en", backdrop: !0, animate: !0, className: null, closeButton: !0, show: !0}, r = {};
    r.alert = function () {
        var a;
    ...
    var s = {
        ...
        pl: {OK: "OK", CANCEL: "Anuluj", CONFIRM: "Potwierd藕"},
        ru: {OK: "OK", CANCEL: "袨褌屑械薪邪", CONFIRM: "袩褉懈屑械薪懈褌褜"},
        zh_CN: {OK: "OK", CANCEL: "鍙栨秷", CONFIRM: "纭"},
        zh_TW: {OK: "OK", CANCEL: "鍙栨秷", CONFIRM: "纰鸿獚"}
    };
