...
!function ($) {
    ...
    Color.prototype = {
        constructor: Color, setColor: function (val) {
            val = val.toLowerCase();
            var that = this;
    ...
    Colorpicker.prototype = {
        constructor: Colorpicker, show: function (e) {
            this.picker.show();
    ...
    var CPGlobal = {
        ...
        sliders: {
            ...
            hue: {maxLeft: 0, maxTop: 100, callLeft: false, callTop: "setHue"},
            alpha: {maxLeft: 0, maxTop: 100, callLeft: false, callTop: "setAlpha"}
        },
