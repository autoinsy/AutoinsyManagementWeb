!function (d) {
    ...
    a.prototype = {
        constructor: a, _events: [], _attachEvents: function () {
            ...
            var y = new Date(this.viewDate), p = y.getUTCFullYear(), z = y.getUTCMonth(),
                ...
                n = this.date && this.date.valueOf(), x = new Date();
    ...
    var c = {
        ...
        parseDate: function (k, u, n) {
            ...
            var m = k && k.match(this.nonpunctuation) || [], k = new Date(), r = {},
                t = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], v = {
                    yyyy: function (s, i) {
