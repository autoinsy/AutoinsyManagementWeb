              ...
              <div class="col-sm-7 infobox-container">
                ...
                <div class="infobox infobox-orange2  ">
                  <div class="infobox-chart">
                    <span class="sparkline" data-values="196,128,202,177,154,94,100,170,224"><canvas width="44"
                                                                                                     height="31"
                                                                                                     style="display: inline-block; width: 44px; height: 31px; vertical-align: top;"></canvas></span>
                  </div>
                  <div class="infobox-data">
                  ...
                  <div class="widget-body">
                    <div class="widget-main">
                      <div id="piechart-placeholder"
                        ...
                        <canvas class="flot-base" width="588" height="150"
                                style="direction: ltr; position: absolute; left: 0; top: 0; width: 588px; height: 150px;"></canvas>
                        <canvas class="flot-overlay" width="588" height="150"
                                style="direction: ltr; position: absolute; left: 0; top: 0; width: 588px; height: 150px;"></canvas>
                        <div class="legend">
                          <div
                            style="position: absolute; width: 48px; height: 100px; top: 15px; right: -30px; background-color: rgb(255, 255, 255); opacity: 0.85;"></div>
                  ...
                  <div class="widget-body">
                    <div class="widget-main padding-4">
                      <div id="sales-charts" style="width: 100%; height: 220px; padding: 0px; position: relative;">
                        <canvas class="flot-base" width="955" height="220"
                                style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 955px; height: 220px;"></canvas>
                        <div class="flot-text"
                             style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);">
                          <div class="flot-x-axis flot-x1-axis xAxis x1Axis"
                               style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;">
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 34px; text-align: center;">
                              0.0
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 106px; text-align: center;">
                              0.5
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 179px; text-align: center;">
                              1.0
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 252px; text-align: center;">
                              1.5
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 325px; text-align: center;">
                              2.0
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 398px; text-align: center;">
                              2.5
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 471px; text-align: center;">
                              3.0
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 544px; text-align: center;">
                              3.5
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 617px; text-align: center;">
                              4.0
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 690px; text-align: center;">
                              4.5
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 763px; text-align: center;">
                              5.0
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 835px; text-align: center;">
                              5.5
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; max-width: 68px; top: 201px; left: 908px; text-align: center;">
                              6.0
                            </div>
                          </div>
                          <div class="flot-y-axis flot-y1-axis yAxis y1Axis"
                            ...
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; top: 94px; left: 6px; text-align: right;">0.000
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; top: 70px; left: 6px; text-align: right;">0.500
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; top: 47px; left: 6px; text-align: right;">1.000
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; top: 23px; left: 6px; text-align: right;">1.500
                            </div>
                            <div class="flot-tick-label tickLabel"
                                 style="position: absolute; top: 0px; left: 6px; text-align: right;">2.000
                            </div>
                          </div>
                        </div>
                        <canvas class="flot-overlay" width="955" height="220"
                                style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 955px; height: 220px;"></canvas>
                        <div class="legend">
                          <div
                            style="position: absolute; width: 69px; height: 60px; top: 14px; right: 14px; background-color: rgb(255, 255, 255); opacity: 0.85;"></div>
                        ...
                        <div id="task-tab" class="tab-pane active">
                          ...
                          <ul id="tasks" class="item-list ui-sortable">
                            <li class="item-orange clearfix">
                              ...
                              <div class="pull-right easy-pie-chart percentage easyPieChart" data-size="30"
                  ...
                  <div class="widget-body">
                    <div class="widget-main no-padding">
                      <div class="slimScrollDiv"
                        ...
                        <div class="slimScrollBar ui-draggable"
                             style="background: rgb(0, 0, 0); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 252.101px;"></div>
                        <div class="slimScrollRail"
                             style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div>
                      </div>
                      <form>
