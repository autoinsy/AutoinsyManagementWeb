...
<script>
  ...
  import add from '../add/AddNotification'
    ...
    mounted: function () {
      ...
      _this.table = $('table').DataTable({
        ...
        ajax: function (data, callback, settings) {
          $.ajax({
            url: _this.HOME + '/notice/allNotice',
            type: 'get',
            data: {
              "page": _this.cur,
              "type": '0',
        ...
        columnDefs: [
          {
            ...
            render: function (data, type, row, meta) {
              let div = "<div class=\"\">\n" +
                ...
                "</a>\n" +
                "<a class=\"green\" href=\"#\" data-toggle=\"modal\" data-target=\"#revampNotice\">\n" +
                "<i class=\"fa fa-pencil bigger-130\"></i>\n" +
                "</a>\n" +
                "<a class=\"red\" href=\"#\">\n" +
                "<i class=\"fa fa-trash bigger-130\"><span style='display: none'>" + row.noticeId + "</span></i>\n" +
                "</a>\n" +
                "</div>";
              return div;
            }
    ...
    methods: {
      deleteData: function (e) {
        ...
        if (confirm('确定删除？')) {
          this.$axios({
            method: 'post',
            url: delete_this.HOME + '/notice/delete?id=' + index,
