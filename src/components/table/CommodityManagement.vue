...
<script>
  import revamp from '../revmap/RevampGoods'
        ...
        columnDefs: [
          {
            ...
            render: function (data, type, row, meta) {
              let div = "<div class=\"\">\n" +
                ...
                "</a>\n" +
                "<a class=\"green\" href=\"#\" data-toggle=\"modal\" data-target=\"#revampGoods\">\n" +
                "<i class=\"fa fa-pencil bigger-130\"></i>\n" +
                "</a>\n" +
                "<a class=\"red\" href=\"#\">\n" +
                "<i class=\"fa fa-trash bigger-130\"><span style='display: none'>" + row.goodsId + "</span></i>\n" +
                "</a>\n" +
                "</div>";
              return div;
            }
