...
<i class="icon-search nav-search-icon"></i>
      ...
      <div class="page-content">
        ...
        <!--&lt;!&ndash;Static &amp; Dynamic Tables&ndash;&gt;-->
        <!--&lt;!&ndash;</small>&ndash;&gt;-->
        <!--&lt;!&ndash;</h1>&ndash;&gt;-->
        <!--</div>-->
        <div class="row">
          <div class="col-xs-12">
            ...
            <!--<a href="#modal-table" role="button" class="green" data-toggle="modal"> 商户管理 </a>-->
            <!--</h4>-->
            <!--<div class="hr hr-18 dotted hr-double"></div>-->
            <div class="row">
              <div class="col-xs-12">
                <h3 class="header smaller lighter blue">表格</h3>
                ...
                <div class="table-responsive">
                  <div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid"><div class="row"><div class="col-sm-6"><div id="sample-table-2_length" class="dataTables_length"><label>Display <select size="1" name="sample-table-2_length" aria-controls="sample-table-2"><option value="10" selected="selected">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> records</label></div></div><div class="col-sm-6"><div class="dataTables_filter" id="sample-table-2_filter"><label>Search: <input type="text" aria-controls="sample-table-2"></label></div></div></div><table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
                    ...
                    </th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="域名: activate to sort column ascending" style="width: 273px;">域名</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="价格: activate to sort column ascending" style="width: 168px;">价格</th><th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="点击数: activate to sort column ascending" style="width: 213px;">点击数</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="

                                                更新
                                            : activate to sort column ascending" style="width: 230px;">
                      <i class="icon-time bigger-110 hidden-480"></i>
                      更新
                    </th><th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="状况: activate to sort column ascending" style="width: 284px;">状况</th><th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" aria-label="" style="width: 278px;"></th></tr>
                    </thead>
...
<i class="icon-trash bigger-120"></i>
                      ...
                      <td class=" ">Feb 18</td>
                      <td class="hidden-480 ">
                        <span class="label label-sm label-success">已注册的</span>
                      </td>
                      <td class=" ">
                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                          <a class="blue" href="#">
...
<i class="icon-trash bigger-120"></i>
                      ...
                      <td class=" ">Feb 22</td>
                      <td class="hidden-480 ">
                        <span class="label label-sm label-info arrowed arrowed-righ">售出</span>
                      </td>
                      <td class=" ">
                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                          <a class="blue" href="#">
...
<i class="icon-trash bigger-120"></i>
                      ...
                      <td class=" ">Feb 12</td>
                      <td class="hidden-480 ">
                        <span class="label label-sm label-info arrowed arrowed-righ">出售</span>
                      </td>
                      <td class=" ">
                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                          <a class="blue" href="#">
